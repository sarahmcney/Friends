...
class Friend { //equivalent of neighbor
	int fnum; //person # it corresponds to
	Friend next;
...
class Person { //equivalent of vertex
	String name;
	boolean student;
	String school;
	Friend first; //front of linked list - equivalent to adjlist
}


class Edge {
	int v1, v2; //gives each endpoint of the edge -- v1 will not equal v2
	Edge(int v1, int v2) {
